...
footer.href = "https://www.instagram.com/muhammadrifaldi_official/";
                          ...
                          if (result.isConfirmed) {
                            Swal.fire({
                              ...
                              inputValidator: (value) => {
                                if (!value) {
                                  return 'Isi dulu dong nisya'
                                }
                              }
                            }).then((result) => {
                              Swal.fire('Okey nisya', 'Nanti aku kabulin kemauan kamu yaa', 'success').then((result) => {
